import { createAdminMaterialVersionRestoreRoute } from "@/app/api/admin/onboarding-kit/[id]/versions/[versionId]/recycle/route";
...
export async function POST(
  ...
  return createAdminMaterialVersionRestoreRoute({
    db: prisma,
